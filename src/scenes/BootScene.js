...
export default class BootScene extends Phaser.Scene {
  ...
  preload() {
    ...
    this.load.image('loreBook',  'Lore_book.png');
    ...
    this.load.audio('halix_say_3', 'audio/dialogue/Halix_say_2.mp3');
    this.load.audio('halix_say_4', 'audio/dialogue/Halix_say_3.mp3');
    this.load.audio('halix_say_5', 'audio/dialogue/Halix_say_4.mp3');
