...
const LOCATIONS = {
  ...
  comms: {
    ...
    say: [
      ...
      '”Your father is meeting an Imperial envoy — off the record — this evening. I expressed my reservations. He believes sixty years of stewardship should have its say.”',
      '”Every day this remains a diplomatic problem is a day Vorrin expands its production. They have already begun boring into the Keth rockbed — three sites confirmed since yesterday. They do not need the decree settled before they act.\n\nThe Shadmen at Tamir\'s Hollow have worked that ground for generations. If anyone can tell us what it can actually sustain — and what we can credibly put in front of the Emperor — it is them.”',
...
const CODEX_LORE = [
  {
    ...
    body: 'The desert world known by two names. Arradius is the Imperial registry designation — the name that appears on Korinth\'s charts, on fief decrees, and on commercial extraction licences. Aridun is the name used by the Shadmen and by those born on its surface; it predates any Korinthian charter by many generations.\n\nAridun\'s surface geology is primarily ancient hard rockbed — vast flat platforms, dramatically weathered and structurally permanent. The dune seas occupy the lower ground between formations: shifting sand fields that are visually striking but geologically secondary to the rock above them.\n\nBeneath the hard surface layer lies an older, softer, more friable stratum — the domain of the Sleepers. The hard layer forms the ceiling of this lower world. Aurun blooms surface through porous sections of rockbed; locating productive sites requires reading the rock face. The Shadmen build their communities at the boundary between the hard and deep layers, accessing the lower passages at certain thinned or fractured junction points. These junctions are central to their underground geography.',
  },
  {
    id: 'sleepers', title: 'The Sleepers',
    body: 'Large creatures resident in the softer friable layer beneath Aridun\'s hard rockbed. They do not bore through the deep rock in the mechanical sense; they displace it — the layer yields to their passage and settles back over a period of hours, leaving no permanent void. The temporary channels they create are navigable for a short period after passage.\n\nThe Sleeper network is the foundation of the planet\'s ecology. Their passage aerates the deep rock and distributes moisture to the lower chambers of the Hollows. The chemical warmth left in a Sleeper\'s wake provides breeding conditions for the deep-rock organisms that form the base of the Shadmen\'s seasonal harvest calendar. The Aurun that accumulates in a Sleeper\'s passage channel surfaces as the bloom visible on the rockbed above active routes.\n\nA healthy Sleeper route sustains life at every scale simultaneously: the deep-rock organisms, the crops grown around Hollow bloom sites, the surface flora attracted to active rockbeds, and the structural properties of the rock itself. Rock above long-active routes develops different physical properties from rock above inactive ones — notably, it is more workable and load-bearing, which is why the Shadmen\'s construction practices are tied to route health.',
  },
  {
    id: 'aurun', title: 'Aurun',
    body: 'A bioluminescent substance deposited by the Sleepers in their passage channels, accumulating over repeated transits across many generations. After a Sleeper has passed, Aurun surfaces through porous sections of rockbed above the route as a bloom — luminescent, structurally active in the rock it infuses, and the primary resource for which Aridun holds Imperial significance.\n\nProcessed Aurun is the Korinth Empire\'s principal energy substrate, used to power the Imperial fleet, city infrastructure, and weapons systems. The empire has no viable alternative source at comparable scale. Aridun is the only world currently capable of meeting Imperial demand.\n\nTwo extraction methods exist. The traditional Shadmen method collects surface bloom from the rockbed in a Sleeper\'s wake, following generational knowledge of routes and collection timing. Practiced within the bloom\'s recovery cycle, this method is sustainable indefinitely. Industrial boring equipment can instead be driven through the hard rockbed to access the concentrated deep deposits directly, yielding substantially higher short-term output. The two methods produce the same material from different stages of the same ecological process.\n\nContact with concentrated Aurun in the deep passage channels is rare. Those exposed to it have reported a heightened sensitivity to pattern and movement in the deep rock. The Veil has accumulated records of such accounts over several generations.',
  },
  {
    id: 'seir', title: 'The Seir',
    body: 'An ancient text held by the Veil, dating from earlier centuries of ecological observation on Aridun. The Veil classifies it as an ecological record rather than a religious document. Its primary content is a detailed description of systemic environmental crisis: the failure of the northern Aurun blooms, the closure of the deep Sleeper channels, and the projected collapse of the rock-world network that sustains Shadmen habitation.\n\nThe text concludes with a statement about resolution, describing one who walks both the surface world and the rock-world opening what it calls "the third path." This conclusion has generated two persistent interpretive traditions among those who study the text.\n\nThe first tradition reads the description as referring to a specific individual — identifiable by their position at the intersection of Imperial and Shadmen worlds — who will appear when the described conditions are met. The second tradition reads it as a description of a type and a moment rather than a named person, arguing that the conditions described will eventually produce someone capable of the described role without specifying who that person is or when they will appear. Both traditions agree on what the text describes. They disagree on whether that description identifies anyone in particular.',
  },
  {
    id: 'calder', title: 'House Calder',
    body: 'An Imperial noble house that has held the Aridun fief for approximately sixty years. The grant was made following a succession dispute in which House Calder lost its original holdings; Aridun was regarded at the time of the grant as a marginal seat unlikely to produce significant Aurun yield or political influence.\n\nThe founding generation on Aridun initiated the first formal contact between an Imperial house and the Shadmen, establishing a working relationship based on Shadmen guidance in exchange for protection of traditional harvesting territories. This arrangement formed the basis of the house\'s governance method and its Aurun production over the two generations that followed. Calder\'s extraction rates have been deliberately restrained, following Shadmen sustainable-yield practices rather than industrial extraction methods.\n\nThe house seat is Saltspire, on Aridun\'s northern coast. Lord Aldric Calder is the current head of house; Eren Calder is his heir. Sela, consort to Lord Aldric and a member of the Veil, was born on Aridun.',
  },
  {
    id: 'vorrin', title: 'House Vorrin',
    body: 'An Imperial noble house with established operations in large-scale mineral extraction across several Imperial systems. Their extraction method on Aridun employs heavy boring equipment driven through the hard rockbed to access concentrated deep Aurun deposits directly, bypassing the surface bloom collection method used by the Shadmen. This approach yields substantially higher short-term output per site than traditional wake collection.\n\nHouse Vorrin holds Imperial contracts for Aurun delivery and has reported production volumes from test sites on Aridun that significantly exceed current Calder output. Their operational headquarters on Aridun is Vorrinhold, located in the central rockbed plains. They maintain a military force — the Vorrin Hounds — for site security and territorial operations.',
  },
  {
    id: 'shadmen', title: 'The Shadmen',
    body: 'The indigenous people of Aridun\'s rockbed, whose documented history on the planet predates Imperial contact by many generations. Their communities — the Hollows — are built into hard rock formations, their chambers carved along the boundary between the surface hard layer and the deeper friable layer below. Hollow entrances are designed to be indistinguishable from natural geology at the surface.\n\nShadmen culture is structured around the Sleeper network. Their route knowledge — which passages the Sleepers use, how those routes shift, and the timing of the seasonal cycles tied to each passage — is empirical and accumulated across generations. It forms the basis of their agricultural calendar, their harvesting practices, and their understanding of when and where it is safe to excavate. Certain passages are observed as off-limits during specific periods due to deep-rock breeding activity that the Shadmen have tracked for generations.\n\nFirst formal contact with an Imperial house — House Calder — was established approximately sixty years ago. Earlier contact attempts by other parties are recorded but did not produce sustained relationships. The Shadmen distinguish between the houses and the Veil as distinct kinds of Imperial presence.',
  },
  {
    id: 'korinth', title: 'House Korinth',
    body: 'The ruling house of the Imperium, whose seat of power is Korinth Prime. House Korinth has held the Imperial throne for approximately four centuries. The Imperium\'s primary energy dependency is processed Aurun, which powers the Imperial fleet, city infrastructure, and weapons systems. Aridun is the only source currently capable of meeting Imperial demand at scale; the empire has no viable alternative.\n\nKorinth administers its holdings through a fief grant system. Grants on resource worlds are evaluated primarily on projected yield. The Pale Legion is the Imperial elite military force; their presence on or near a contested world indicates active Imperial interest in the resolution of fief terms.\n\nThe current Emperor is Valkren of House Korinth.',
  },
  {
    id: 'saltspire', title: 'Saltspire',
    body: 'The capital city of Aridun, located on the northern coast on a hard rockbed formation that rises directly from the sea. The city is built primarily into the formation rather than across open ground — its streets, chambers, and walls cut from the same ancient stone as the surrounding rockbed. Its position provides natural shelter from the dune seas extending to the south and east, and natural defensive depth.\n\nThe Residency — the palace and administrative centre for whoever holds the Aridun fief — occupies the formation\'s interior. Its rooms are cut from living rock: the great Hall, the Court, the Communications room, the Veil sanctum, the private quarters and service wings, the Corsair deck. The building has been the seat of Aridun\'s governance since Saltspire was established as its capital.\n\nThe Corsair hangars beneath the Residency service the winged craft used for travel across Aridun\'s open terrain.',
  },
  {
    id: 'veil', title: 'The Veil',
    body: 'An ancient order whose method is the long-term study of planetary ecology through embedded participation in indigenous communities. The Veil embeds members within the cultures that hold the deepest knowledge of a planet\'s systems — on Aridun, the Shadmen — and accumulates understanding across generations of sustained observation and earned relationship. Their Aridun archive spans several centuries and represents the most comprehensive record of Sleeper behaviour, route patterns, bloom cycles, and deep-rock ecology in existence.\n\nThe Veil distinguishes carefully between observation, inference, and what they term reading: the projection of systemic behaviour based on long-period pattern data. Their ecological projections have historically shown a degree of accuracy that, to those unfamiliar with the method, can resemble foresight. The Seir is one of their primary research texts; the Veil classifies it as an ecological document.\n\nThe Veil\'s method is politically distinctive: the knowledge they accumulate belongs in practice to the indigenous communities who generated it. The order\'s role is to understand and record, not to transfer that knowledge to the houses that administer the same worlds. This constraint is the foundation of the trust that makes their method possible. The Veil has maintained a formal presence at the Residency in Saltspire since approximately the first generation of Calder rule on Aridun.',
  },
];
...
const CODEX_CHARACTERS = {
  'Lord Aldric': {
    ...
    body: 'Second-generation Calder on Aridun and current head of the house. His father established the first formal relationship with the Shadmen; Aldric inherited and maintained that arrangement across approximately thirty years of rule. His governance approach has been administrative and diplomatic — he formalised the agreements his father initiated, paid consistent prices for Shadmen guidance, and pursued objections to competitor extraction activity through official Korinth channels.\n\nAldric was educated at the Calder house academy on Sethara and returned to Aridun as a young adult to assume the seat. His consort, Sela, is Aridun-born and a member of the Veil. His heir, Eren, was raised on Aridun.',
  },
  'Halix': {
    title: 'Halix · Reckoner',
    body: 'Intelligence officer to House Calder, serving in that capacity for approximately fifteen years. Halix holds the rank of Reckoner — a practitioner of the analytical discipline developed through the Imperial intelligence schools, trained to resolve complex situational information into structured assessment. The method is documented and traceable; Reckoners are valued specifically for the absence of intuition from their conclusions.\n\nHis operational archive on Aridun covers Vorrin drilling schedules, Pale Legion patrol patterns, Shadmen route activity, and economic projections. It is the most comprehensive intelligence picture in the Residency. His background before entering Calder service is on file.',
  },
  'Mother Ysolde': {
    title: 'Mother Ysolde · Elder of the Veil',
    body: 'Senior representative of the Veil at the Calder court in Saltspire, a position she has held since before the current lord\'s tenure. Her specialisation within the Veil is long-period ecological pattern reading: the multi-generational rhythms of Sleeper migration, deep water table variation, and slow systemic signals in the rock that require centuries of data to interpret reliably. She holds the Veil\'s longest-running continuous time-series on Aridun.\n\nYsolde has been present at the Residency through the tenures of both the current lord and his father. Her primary research text is the Seir, which she approaches as an ecological document. She is the oldest member of the Residency by a considerable margin.',
  },
  'Sela': {
    title: 'Sela · of the Veil',
    body: 'Consort to Lord Aldric Calder and a member of the Veil. She was born on Aridun and raised in the deep desert, outside any house or administrative settlement. Her knowledge of the rock is practical as well as observational — she is familiar with Sleeper route behaviour and bloom cycle chemistry from direct experience rather than study alone.\n\nSela has been resident at the Residency for approximately twenty years. Within the Veil her specialisation is close indigenous ecology: the Shadmen\'s sustainable harvesting methods, bloom chemistry, and the interaction between Sleeper routes and the food systems that depend on them. She is the mother of Eren Calder.',
  },
  'Master Orlin': {
    title: 'Master Orlin · Physician',
    body: 'Court physician to House Calder, resident at the Residency for approximately a decade. His area of specialisation is environmental medicine: the physiological effects of Aridun\'s conditions on human inhabitants over sustained periods, including altitude dryness, mineral exposure from extended time in the deep rock, and the documented effects of Aurun contact. He maintains the Residency\'s medical records and has treated the Calder household and court staff throughout his tenure.\n\nOrlin trained off-world before taking the Aridun post. His familiarity with Aridun-specific conditions has developed entirely through practice on the planet.',
  },
  'Brannic': {
    title: 'Brannic · Marshal, Saltguard',
    body: 'Commander of the Saltguard — House Calder\'s standing military force of approximately four hundred personnel — and holder of the Bladewarden title. Brannic is Aridun-born; his family has served the Calder household across multiple generations, and he grew up in the Residency\'s service quarter. He trained under the previous Bladewarden and has commanded the Saltguard for eight years.\n\nHis command approach has been adapted to Aridun\'s terrain: small-unit tactics suited to the rockbed and dune environment, and working relationships with Shadmen contacts in the territory around Saltspire. He describes the latter as the most strategically significant work of his tenure. He was educated on Sethara and is by background the most institutionally Korinth-aligned member of the court.',
  },
};
