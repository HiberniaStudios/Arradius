...
const CODEX_LORE = [
  {
    ...
    body: 'The desert world known by two names. Arradius is the Imperial registry designation — the name that appears on Korinth\'s charts, on fief decrees, and on commercial extraction licences. Aridun is the name used by the Shadmen and by those born on its surface; it predates any Korinthian charter by many generations.\n\nAridun is not a sand world. It is a rock world. Vast platforms of ancient hard rockbed cover most of its surface — flat, dramatically weathered, structurally permanent. The dune seas occupy the lower ground between formations: shifting sand fields that are visually striking but geologically secondary. The rock is the foundation of everything that lives here.\n\nBeneath the hard surface layer lies an older, softer, more friable stratum — the domain of the Sleepers. The hard layer forms the ceiling of this lower world. Aurun blooms surface through porous sections of rockbed, not through sand; locating productive sites requires reading the rock face. The Shadmen build their communities at the boundary between the hard and deep layers, accessing the lower passages at certain thinned or fractured junction points. These junctions are central to their underground geography.',
  },
  {
